**Handle:** paulius.eth  
**Ethereum Address:** 0x523B5b2Cc58A818667C22c862930B141f85d49DD    


# 1. function collectFees does not check that the feeAddress is set
## Summary
...
# 2. modifier onlyDAO also allows minter
## Summary
...
# 3. ElasticDAO function initialize does not ensure that the ecosystem model address is not zero
## Summary
...
1
## Vulnerability Details
There is a comment in the requirements: "The ecosystem model address cannot be the zero address"
...
# 4. function decreaseAllowance does not allow new allowances of 0
## Summary
...
# 5. function updateNumberOfTokenHolders in the contract Token can be invoked by anyone
## Summary
...
# 6. Inconsistent values for the Transfer event 
## Summary
...
# 7. Serialization can be invoked by anyone 
## Summary
...
# 8. DAO summoners serialization loop does not delete previous entries
## Summary
